...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_type) || empty($product_description)){
      ...
      $insert = "INSERT INTO products(name, price, type, description, image) VALUES('$product_name', '$product_price', '$product_type', '$product_description', '$product_image')";
...
<div class="admin-product-form-container">
   ...
   <a href="dashboard.php" class="btn">go home</a>
   ...
   <div class="product-display">
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               <a href="uploader_update.php?edit=<?php echo $row['name']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
               <a href="uploader.php?delete=<?php echo $row['name']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
